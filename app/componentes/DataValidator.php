 ...
 * @version 1.0
 * @link https://github.com/rafaelwendel/Data_Validator/
 */
...
class DataValidator {
     ...
     * @return void
     * Chamada de cada função validadora afim de configurar um 
     * erro sendo seu padrão um array() de erros com o seguinte
     * padrão errors[''.$campo.''][] já que o pattern['prefix']
     * e pattern['sufix'] é inicializado com uma string vazia
     * e seu valor 
     */
    ...
    public function is_required(){
        // Se a variavel for vazia executa o método
        // set_error passando como parametro uma string
        // formatada dinamicamente com a mensagem setada
        // no array _messages e o campo setado na função
        // set() e retorna  
